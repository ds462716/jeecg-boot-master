      ...
      <a-col :md="24" :sm="24">
        <div class="sign" style="text-align: left;height: inherit">
          ...
          <a-col :span="24" style="margin-top: 5px">
            <a-form :form="form">
              <table width="100%" id="contentTable" class="tableStyle" style="border: 1px black">
                ...
                <tr>
                  <td  colspan="6" style="text-align: center;border: 1px solid #000000;padding: 3px 3px;font-size: small">
                  </td>
          ...
          <a-col :span="24" style="margin-top: 5px">
            ...
            <a-input style="width: 10%;text-align: left" value="卢菁" />
            <span style="margin-left: 3%">
              收货员：
            </span>
            <a-input style="width: 10%;text-align: left" value="张庆"/>
            <span style="margin-left: 3%">
              验收员：
            </span>
            <a-input style="width: 10%;text-align: left" value="涂建"/>
          </a-col>
        </div>
      </a-col>
    </section>
...
<script>
  ...
  export default {
    ...
    name: 'PdStockRecordInPrintModalJJFSYY',
    props:{
      reBizCode:{
        type: String,
        default: ''
