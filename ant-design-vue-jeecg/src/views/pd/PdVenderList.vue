<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('生产厂家')">导出</a-button>
    ...
    <pdVender-modal ref="modalForm" @ok="modalFormOk"></pdVender-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/pd/pdVender/list",
          delete: "/pd/pdVender/delete",
