<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" icon="plus">批次退货出库</a-button>
      <a-button @click="handleUniqueAdd" type="primary" icon="plus">唯一码退货出库</a-button>
    ...
    <pd-stock-record-return-modal ref="modalForm" @ok="modalFormOk"></pd-stock-record-return-modal>
    <pd-unique-stock-record-return-modal ref="uniqueModalForm" @ok="modalFormOk"></pd-unique-stock-record-return-modal>
  </a-card>
</template>
...
<script>
  ...
  import PdStockRecordReturnModal from "./modules/PdStockRecordReturnModal";
  import PdUniqueStockRecordReturnModal from "./modules/PdUniqueStockRecordReturnModal";

  export default {
    name: "PdStockRecordReturnList",
    mixins:[JeecgListMixin],
    components: {
      PdUniqueStockRecordReturnModal,
      PdStockRecordReturnModal,
    ...
    data () {
      return {
        ...
        url: {
          list: "/pd/pdStockRecordReturn/list",
          delete: "/pd/pdStockRecordReturn/delete",
          // deleteBatch: "/pd/pdStockRecordReturn/deleteBatch",
          exportXlsUrl: "/pd/pdStockRecordReturn/exportXls",
          departList:"/pd/pdDepart/getSysDepartList",
          // importExcelUrl: "pd/pdStockRecordReturn/importExcel",
        },
        dictOptions:{
        },
      }
