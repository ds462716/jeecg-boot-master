<template>
  <a-card :bordered="false">
    ...
    <pd-product-stock-init-modal ref="modalForm" @ok="modalFormOk"></pd-product-stock-init-modal>
  </a-card>
</template>
...
<script>
  ...
  import PdProductStockInitModal from "./modules/PdProductStockInitModal";

  export default {
    name: "PdProductStockInitList",
    mixins:[JeecgListMixin],
    components: {
      PdProductStockInitModal,
    ...
    data () {
      return {
        ...
        url: {
          list: "/pd/pdProductStockInit/list",
          delete: "/pd/pdProductStockInit/delete",
          // deleteBatch: "/pd/pdProductStockInit/deleteBatch",
          exportXlsUrl: "/pd/pdProductStockInit/exportXls",
          querySupplier:"/pd/pdSupplier/getSupplierList",
          // importExcelUrl: "pd/pdProductStockInit/importExcel",
        },
        dictOptions:{
        },
      }
