<template>
  <a-card :bordered="false">
    ...
    <rp-supplier-reagent-use-report-main ref="RpSupplierReagentUseReportMain"></rp-supplier-reagent-use-report-main>
...
<script>
  ...
  import RpSupplierReagentUseReportMain from "./RpSupplierReagentUseReportMain";
  ...
  export default {
    name: "RpSupplierReagentUseReport",
    mixins:[JeecgListMixin],
    components: {
      RpSupplierReagentUseReportMain,
      JDictSelectTagExpand,JEllipsis
    },
    data () {
      return {
        description: '供应商试剂使用统计',
        textMaxLength:15,
        ...
        url: {
          list: "/pd/pdStatisticalReport/supplierReagentUseReport",
          querySupplier:"/pd/pdSupplier/getSupplierList",
          exportXlsUrl: "/pd/pdStatisticalReport/exportSupplierReagentUseReportXls",
        },
        dictOptions:{
          inType:[],
        },
    ...
    methods: {
      ...
      detailBtn(record){
        ...
        this.$refs.RpSupplierReagentUseReportMain.show(param);
      },
      /**重写导出方法**/
