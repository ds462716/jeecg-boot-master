      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            align:"center",
            width:'250px',
            dataIndex: 'chargeDosageNum'
          },
          {
            title:'收费产品金额',
            align:"center",
            width:'250px',
            dataIndex: 'chargeDosagePrice'
          },
          {
            title:'未收费产品数量',
            align:"center",
            width:'250px',
            dataIndex: 'noChargeDosageNum'
          },
          {
            title:'未收费产品金额',
            align:"center",
            width:'250px',
            dataIndex: 'noChargeDosagePrice'
          },
          {
            title: '操作',
            dataIndex: 'action',
        ...
        url: {
          list: "/pd/pdStatisticalReport/departUseReport",
          departList: "/pd/pdDepart/queryListTree",
          exportXlsUrl: "/pd/pdStatisticalReport/exportDepartUseReportXls",
        },
        dictOptions:{
          inType:[],
        },
