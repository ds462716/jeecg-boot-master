<template>
  <a-card :bordered="false">
    ...
    <pd-product-stock-init-examine-modal ref="modalForm" @ok="modalFormOk"></pd-product-stock-init-examine-modal>
  </a-card>
</template>
...
<script>
  ...
  import PdProductStockInitExamineModal from "./modules/PdProductStockInitExamineModal";

  export default {
    name: "PdProductStockInitExamineList",
    mixins:[JeecgListMixin],
    components: {
      PdProductStockInitExamineModal,
    ...
    data () {
      return {
        ...
        url: {
          list: "/pd/pdProductStockInit/examineList",
