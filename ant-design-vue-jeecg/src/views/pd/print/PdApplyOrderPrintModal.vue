      ...
      <a-col :md="24" :sm="24">
        <div class="sign" style="text-align: left;height: inherit">
          ...
          <a-col :span="24">
            ...
            <a-input style="width: 30%;text-align: left" disabled v-model="record.applyNo"/>
            <span style="margin-left: 12.5%">
              申领日期：
            </span>
            <a-input style="width: 30%;text-align: left" disabled v-model="record.applyDate"/>
          </a-col>
  ...
  export default {
    ...
    data(){
      return {
        ...
        columns: [
          ...
          { title: '申领数量',   align:"center",dataIndex: 'applyNum'},
    ...
    methods: {
      ...
      show(record){
        this.visible = true;
        this.record = record;
        this.dataSource = record.pdApplyDetailList;
