  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/pd/pdDistributor/save",
          edit: "/pd/pdDistributor/update",
    ...
    methods: {
      ...
      edit (record) {
        ...
        if(record.hasOwnProperty("id")){
          this.validateDistributorId = record.id;
      ...
      validateName(rule, value, callback){
        var params = {
          tableName: 'pd_distributor',
          fieldName: 'name',
          fieldVal: value,
          dataId: this.validateDistributorId
        };
