            ...
            <a-row>
              ...
              <a-col :span="6">
                <a-form-item label="出库类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <j-dict-select-tag-expand  @change="outTypeChange" type="list" v-decorator="['outType', validatorRules.outType]" :trigger-change="true" dictCode="out_type" placeholder="请选择出库类型"/>
                </a-form-item>
              </a-col>
            </a-row>
          </a-form>
...
<script>
  ...
  export default {
    name: 'PdApplyStockRecordOutModal',
    ...
    methods: {
      edit (data) {
        ...
        this.model.outType="1";//出库类型
        this.form.setFieldsValue(pick(this.model,'outType'));
        //入库科室
