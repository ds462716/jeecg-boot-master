  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/pds/pdAllocationRecord/list",
          delete: "/pds/pdAllocationRecord/delete",
          deleteBatch: "/pds/pdAllocationRecord/deleteBatch",
          exportXlsUrl: "/pds/pdAllocationRecord/exportXls",
          importExcelUrl: "pds/pdAllocationRecord/importExcel",
        },
        dictOptions:{
        },
