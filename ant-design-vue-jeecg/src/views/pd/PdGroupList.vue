<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('产品组别')">导出</a-button>
    ...
    <pdGroup-modal ref="modalForm" @ok="modalFormOk"></pdGroup-modal>
  </a-card>
</template>
