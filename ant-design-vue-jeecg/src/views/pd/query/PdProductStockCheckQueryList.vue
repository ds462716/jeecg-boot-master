<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="盘点单号">
              <a-input placeholder="请输入盘点单号" v-model="queryParam.checkNo"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('盘点明细')">导出</a-button>
    </div>
    <!-- table区域-begin -->
    <div>
      <a-table
...
<script>
  ...
  export default {
    name: "PdProductStockCheckQueryList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/pd/pdProductStockCheck/pdProductStockCheckQueryList",
