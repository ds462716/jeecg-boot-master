<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('配送商')">导出</a-button>
    ...
    <pd-distributor-modal ref="modalForm" @ok="modalFormOk"></pd-distributor-modal>
  </a-card>
</template>
...
<script>
  ...
  import PdDistributorModal from "./modules/PdDistributorModal";

  export default {
    name: "PdDistributorList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/pd/pdDistributor/list",
          delete: "/pd/pdDistributor/delete",
          deleteBatch: "/pd/pdDistributor/deleteBatch",
          exportXlsUrl: "/pd/pdDistributor/exportXls",
          importExcelUrl: "pd/pdDistributor/importExcel",
          batchDisable: "pd/pdDistributor/batchDisable",
        },
        dictOptions:{
          status:[],
        },
    ...
    methods: {
      ...
      batchDisable(status) {
        if (this.selectedRowKeys.length <= 0) {
          ...
          that.$confirm({
            title: "确认操作",
            content: "是否" + (status == 0 ? "启用" : "停用") + "选中配送商?",
            onOk: function () {
