...
public class HforcerInfoServiceImpl extends ServiceImpl<HforcerInfoMapper, HForcerInfo> implements IHforcerInfoService {
    ...
    @Override
    public Page<HForcerInfo> selectList(Page<HForcerInfo> page, HForcerInfo forcerInfo) {
        return hforcerInfoMapper.selectList(page,forcerInfo);
    }
    /**
     * 判断是否已注册
     * @param macAddress
    ...
    public void saveConsumables(Map<Object,Object> map) {
        ...
        hForcer.setIsDisable(PdConstant.DISABLE_ENABLE_STATUS_1);//默认未启用
